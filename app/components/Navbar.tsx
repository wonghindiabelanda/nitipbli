...
export default function Navbar() {
  ...
  return (
    <>
      <header className="w-full fixed top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-[#0f0f11]/70 border-b border-gray-200 dark:border-gray-700">
        ...
        {/* Mobile Menu */}
        {open && (
          <div className="md:hidden w-full backdrop-blur-md bg-white/70 dark:bg-[#0f0f11]/70 border-t border-gray-200 dark:border-gray-700">
