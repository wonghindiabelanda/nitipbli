    ...
    <header className="flex justify-between items-center p-6 max-w-6xl mx-auto">
      ...
      {open && (
        <div className="fixed inset-0 bg-black/50 z-40" onClick={() => setOpen(false)}>
          <div className="absolute top-0 left-0 w-full bg-white dark:bg-[#1a1c23] shadow-lg p-6 flex flex-col gap-6 z-50" onClick={(e) => e.stopPropagation()}
          >
            {/* Close + Theme Toggle */}
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setOpen(false)} className="text-black dark:text-white border border-gray-600 px-3 py-1 rounded-lg" >✕
              </button>
            </div>
